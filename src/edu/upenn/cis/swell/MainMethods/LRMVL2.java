...
public class LRMVL2 implements Serializable {
	...
	public static void main(String[] args) throws Exception{
		...
		if(opt.trainUnlab){
			...
			wout.writeEigenDict();
			if(!opt.typeofDecomp.equals("TwoStepLRvsW") && !opt.typeofDecomp.equals("LRMVLVariant2")  && !opt.typeofDecomp.equals("LRMVL") && !opt.kdimDecomp)
		...
		if (opt.train){
			...
			contextSpecificEmbed=contextPCARep.generateProjectionsLRMVL((Matrix)matrices[0], 
...
public static HashMap<Integer,Integer> setwordDict(HashMap<Integer,Integer> wDict){
	...
	public static Object[] deserializeCCAVariantsRun(Options opt) throws ClassNotFoundException{
		...
		if(opt.typeofDecomp.equals("TwoStepLRvsW") || opt.typeofDecomp.equals("LRMVLVariant2")|| opt.typeofDecomp.equals("LRMVL")){
